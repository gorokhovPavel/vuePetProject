export default class Mover {
    ...
    static _moveObject(block){
        ...
        if (block) {
            ...
            if ( op || ff )
                block.addEventListener( 'onmousedown', _saveXY, false );
        ...
        function _saveXY( obj_event ) {
            ...
            if(obj_event.currentTarget.className.indexOf('move') == -1)
                return;
            ...
            if (op || ff)
                document.addEventListener("onmousemove", _moveBlock, false);
        }
